#!/usr/bin/env python3
"""Vendored, unmodified, from flop-labs/tclk PR #13 (examples/hashlock_walkthrough.py),
by contributor xamdkx, Apache-2.0, unmerged as of this writing. Used here only as a
cross-check fixture for tests/test_tclk_verify.py — this repo's own tclk_verify.py is an
independent port, and this file's golden-vector-verified canonical_json/domain_hash/
apply_frame logic is what that port's tests are checked against. Not part of the shipped
tool; ships only under tests/.
